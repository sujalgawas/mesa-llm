...
class TestEpisodicMemory:
    ...
    def test_retrieve_top_k_entries(self, mock_agent):
        ...
        # score = 5 - (100 - 98) = 3
        entry_A = MemoryEntry(content={"importance": 5, "id": "A"},step=98, agent=mock_agent) 
        # score = 1 - (100 - 99) = 0
        entry_B = MemoryEntry(content={"importance": 1, "id": "B"},step=99,agent=mock_agent) 
        # score = 4 - (100 - 90) = -6
        entry_C = MemoryEntry(content={"importance": 4, "id": "C"}, step=90, agent=mock_agent) 
        # score = 4 - (100 - 95) = -1
        entry_D = MemoryEntry(content={"importance": 4, "id": "D"}, step=95, agent=mock_agent) 
