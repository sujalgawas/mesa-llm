...
'''
    ...
    →Internal State: [Aggresive, Injured]    
    →Reasoning prompt: Look around you and see if there are any protestors, restrain yourself as much as possible to vocal measures. 
    ...
    →Plan: 
        [thought]: I need to supress the protestors, but I am injured and therefore I will target the injured protestor first.
        [action]: Move towards (2,8)

        
    ######## Agent 2: Protestor ##########
    →System prompt: You are a protestor in a city. You are capable of throwing stones and shouting slogans.
    →Ineternal State: [Active, Injured]
    →Reasoning Prompt: Look around you and see if there are any police officers, keep distance from them and spread your propoganda.
    ...
    →Plan:
        [thought]: I need to spread my propoganda but there is a police officer in front of me, I can't run. I will have to throw a stone at him.
    ...
    →Plan:
        [thought]: I am safe from this police officer, now I have to go away from the others and find fellow protestors to spread my propoganda.
...
# Make function that genereates the observation for a particular agent at a given point of time
