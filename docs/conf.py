#!/usr/bin/env python3
#
# Mesa-LLM documentation build configuration file.
#
...
# of the sidebar.
# html_logo = "images/mesa-llm.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
# html_favicon = "images/mesa-llm.ico"
...
man_pages = [("index", "mesa-llm", "Mesa-LLM Documentation", ["Project Mesa Team"], 1)]
